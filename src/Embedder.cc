...
Embedder::Embedder ()
{
	...
	embdata.setData (emb) ;
	//std::cout << Args.EncAlgo.getValue() << std::endl;
	//std::cout << Args.EncMode.getValue() << std::endl;
	//std::cout << Args.Compression.getValue() << std::endl;
	//std::cout << Args.Checksum.getValue() << std::endl;

	ToEmbed = embdata.getBitString() ;
	//std::cout << ToEmbed << std:endl;
	ToEmbed.print();
...
void Embedder::embed ()
{
	...
	std::cout << Globs.TheCvrStgFile << std::endl;
